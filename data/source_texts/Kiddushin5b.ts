        ...
        rashi: [
            {
                ...
                englishText: 'Given the phrasing, you might have thought that "He gave and She spoke" is also invalid, since the Braita emphasized "He gave and He spoke".'
            }
        ],
        tosfos: []
    },
        ...
        tosfos: [
            {
                id: 'tos-4-1',
                scholar: 'Tosfos',
                hebrewText: 'והתנן האומר אהא הרי זה נזיר - תימה, דבפ"ק דנדרים מוקי שמואל מתניתין דהתם כר\' יהודה, דאמר ידים שאין מוכיחות לא הוו ידים... והכא משמע דסבר כרבנן?',
                englishText: 'Question: In Nedarim, Shmuel establishes the Mishna according to R\' Yehuda (who invalidates ambiguous handles). Here he seems to rule like the Rabbis? '
            }
        ]
    },
    {
